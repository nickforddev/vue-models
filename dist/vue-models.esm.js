...
var lodash_some = createCommonjsModule(function (module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
var _objectKeysInternal$2 = function (object, names) {
  ...
  var result = [];
  var key;
  for (key in O) if (key != IE_PROTO$1$1) _has$2(O, key) && result.push(key);
  // Don't enum bug & hidden keys
...
var es6_array_iterator = _iterDefine$2(Array, 'Array', function (iterated, kind) {
...
var TO_STRING_TAG = _wks$2('toStringTag');
...
for (var i = 0; i < DOMIterables.length; i++) {
  ...
  _iterators$2[NAME] = _iterators$2.Array;
}
...
_export$2(_export$2.S + _export$2.F * (_library$2 || !USE_NATIVE), PROMISE, {
  // 25.4.4.6 Promise.resolve(x)
  resolve: function resolve(x) {
    return _promiseResolve(_library$2 && this === Wrapper ? $Promise : this, x);
  }
});
_export$2(_export$2.S + _export$2.F * !(USE_NATIVE && _iterDetect$2(function (iter) {
...
var lodash_merge$1 = createCommonjsModule$1(function (module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
var f$7 = _descriptors$2 ? gOPD$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (_has$2(O, P)) return _propertyDesc$2(!_objectPie.f.call(O, P), O[P]);
};
...
var HIDDEN = _wks$2('_hidden');
var TO_PRIMITIVE = _wks$2('toPrimitive');
...
var setSymbolDesc = _descriptors$2 && _fails$2(function () {
  return _objectCreate$2(dP$1$1({}, 'a', {
    get: function () { return dP$1$1(this, 'a', { value: 7 }).a; }
  })).a != 7;
}) ? function (it, key, D) {
  var protoDesc = gOPD(ObjectProto$1$1, key);
...
var wrap = function (tag) {
  var sym = AllSymbols[tag] = _objectCreate$2($Symbol[PROTOTYPE$2$1]);
  sym._k = tag;
  return sym;
};
...
var $defineProperty = function defineProperty(it, key, D) {
  ...
  if (_has$2(AllSymbols, key)) {
    if (!D.enumerable) {
      if (!_has$2(it, HIDDEN)) dP$1$1(it, HIDDEN, _propertyDesc$2(1, {}));
      it[HIDDEN][key] = true;
    } else {
...
var $create = function create(it, P) {
  return P === undefined ? _objectCreate$2(it) : $defineProperties(_objectCreate$2(it), P);
};
var $propertyIsEnumerable = function propertyIsEnumerable(key) {
  var E = isEnum.call(this, key = _toPrimitive$2(key, true));
  if (this === ObjectProto$1$1 && _has$2(AllSymbols, key) && !_has$2(OPSymbols, key)) return false;
  return E || !_has$2(this, key) || !_has$2(AllSymbols, key) || _has$2(this, HIDDEN) && this[HIDDEN][key] ? E : true;
};
var $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(it, key) {
  it = _toIobject$2(it);
  key = _toPrimitive$2(key, true);
  if (it === ObjectProto$1$1 && _has$2(AllSymbols, key) && !_has$2(OPSymbols, key)) return;
  var D = gOPD(it, key);
...
var $getOwnPropertySymbols = function getOwnPropertySymbols(it) {
  ...
  var key;
  while (names.length > i) {
    if (_has$2(AllSymbols, key = names[i++]) && (IS_OP ? _has$2(ObjectProto$1$1, key) : true)) result.push(AllSymbols[key]);
  } return result;
};
...
if (!USE_NATIVE$1) {
  $Symbol = function Symbol() {
    ...
    if (_descriptors$2 && setter) setSymbolDesc(ObjectProto$1$1, tag, { configurable: true, set: $set });
    return wrap(tag);
  };
  _redefine$2($Symbol[PROTOTYPE$2$1], 'toString', function toString() {
    return this._k;
  });
  ...
  if (_descriptors$2 && !_library$2) {
    _redefine$2(ObjectProto$1$1, 'propertyIsEnumerable', $propertyIsEnumerable, true);
  }

  _wksExt.f = function (name) {
    return wrap(_wks$2(name));
  };
}
...
for (var wellKnownSymbols = _objectKeys$2(_wks$2.store), k = 0; wellKnownSymbols.length > k;) _wksDefine(wellKnownSymbols[k++]);
...
$Symbol[PROTOTYPE$2$1][TO_PRIMITIVE] || _hide$2($Symbol[PROTOTYPE$2$1], TO_PRIMITIVE, $Symbol[PROTOTYPE$2$1].valueOf);
// 19.4.3.5 Symbol.prototype[@@toStringTag]
_setToStringTag$2($Symbol, 'Symbol');
...
function processHeaders(default_headers, passed_headers) {
  var headers = lodash_merge$1({}, default_headers, passed_headers);
...
function Request() {
  ...
  var options = lodash_merge$1({}, defaults$1(), _options);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            config = lodash_merge$1({}, defaults, _config);
...
function isDef(v) {
  ...
  return !lodash_some.apply(undefined, _toConsumableArray(v).concat([lodash_isempty]));
}
...
var getChangedKeys = function getChangedKeys(oldData, newData) {
  var updated = lodash_merge({}, oldData, newData);
  var output = lodash_reduce(oldData, function (result, value, key) {
    return lodash_isequal(value, updated[key]) ? result : result.concat(key);
  }, []);
  return output;
};
...
var getDefaultsFromSchema = function getDefaultsFromSchema(schema) {
  ...
  var immutable = function immutable() {
    return lodash_merge({}, default_attrs);
  };
  return immutable;
};
...
var modelToJSON = function modelToJSON(model) {
  ...
  var output = lodash_merge({}, model.$data, computed);
...
var resetState = function resetState(state, defaults) {
    ...
    beforeDestroy: function beforeDestroy() {
      if (isDef(this.$models)) {
        for (var key in this.$models) {
          if (!lodash_get(this.$models[key], '$options.persist')) {
...
var USE_NATIVE$1$1 = !!function () {
  try {
    ...
    // unhandled rejections tracking support, NodeJS Promise without it fails @@species test
    return (isNode$1$1 || typeof PromiseRejectionEvent == 'function') && promise.then(empty$1) instanceof FakePromise;
  } catch (e) { /* empty */ }
}();
...
_export(_export.S + _export.F * (_library || !USE_NATIVE$1$1), PROMISE$1, {
  // 25.4.4.6 Promise.resolve(x)
  resolve: function resolve(x) {
    return _promiseResolve$1(_library && this === Wrapper$1 ? $Promise$1 : this, x);
  }
});
_export(_export.S + _export.F * !(USE_NATIVE$1$1 && _iterDetect(function (iter) {
...
var wrap$1 = function (tag) {
  var sym = AllSymbols$1[tag] = _objectCreate($Symbol$1[PROTOTYPE$3]);
  sym._k = tag;
  return sym;
};

var isSymbol$2 = USE_NATIVE$2 && typeof $Symbol$1.iterator == 'symbol' ? function (it) {
  return typeof it == 'symbol';
} : function (it) {
...
if (!USE_NATIVE$2) {
  ...
  _redefine($Symbol$1[PROTOTYPE$3], 'toString', function toString() {
    return this._k;
  });
  ...
  if (_descriptors && !_library) {
    _redefine(ObjectProto$2, 'propertyIsEnumerable', $propertyIsEnumerable$1, true);
  }
...
for (var es6Symbols$1 = (
  // 19.4.2.2, 19.4.2.3, 19.4.2.4, 19.4.2.6, 19.4.2.8, 19.4.2.9, 19.4.2.10, 19.4.2.11, 19.4.2.12, 19.4.2.13, 19.4.2.14
  'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'
).split(','), j$1 = 0; es6Symbols$1.length > j$1;)_wks(es6Symbols$1[j$1++]);

for (var wellKnownSymbols$1 = _objectKeys(_wks.store), k$1 = 0; wellKnownSymbols$1.length > k$1;) _wksDefine$1(wellKnownSymbols$1[k$1++]);
...
var Type = function () {
  ...
  _createClass(Type, [{
    ...
    value: function getValue(value) {
      return this.key ? lodash_get(value, this.key) || value : value;
    }
  }, {
    key: 'in',
...
var Model = function () {
  ...
  function Model() {
    ...
    var _options = !(options instanceof Array) ? [options] : options;
    _options = lodash_reduce(_options, function (sum, n) {
      return lodash_merge({}, sum, n);
    });
    ...
    var default_options = {
      ...
      computed: {
        ...
        $request: function $request() {
          return lodash_get(this._vm, '$request') || Request;
        }
      },
      data: function data() {
      ...
      methods: {
        ...
        save: function save(_body, options) {
          var _this2 = this;

          var _options = {
            path: ''
          };
          lodash_merge(_options, options);
          var changed = getDiff(this.$data, _body);
          if (lodash_isempty(changed)) {
        ...
        set: function set(data) {
          ...
          lodash_merge(this, data_decoded);
          return this;
        },
        reset: function reset(defaults) {
          return resetState(this.$data, default_attributes());
        },
