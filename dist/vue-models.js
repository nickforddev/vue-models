...
var _isPlaceholder_1$2 = _isPlaceholder$2;
function _curry1$2(fn) {
  return function f1(a) {
    if (arguments.length === 0 || _isPlaceholder_1$2(a)) {
      return f1;
    } else {
      return fn.apply(this, arguments);
    }
  ...
  return function f2(a, b) {
    switch (arguments.length) {
      case 0:
        return f2;
      case 1:
        return _isPlaceholder_1$2(a) ? f2 : _curry1_1$2(function (_b) {
          return fn(a, _b);
        });
      default:
        return _isPlaceholder_1$2(a) && _isPlaceholder_1$2(b) ? f2 : _isPlaceholder_1$2(a) ? _curry1_1$2(function (_a) {
          return fn(_a, b);
        }) : _isPlaceholder_1$2(b) ? _curry1_1$2(function (_b) {
          return fn(a, _b);
        }) : fn(a, b);
    }
  };
}
var _curry2_1$2 = _curry2$2;
  ...
  return function f3(a, b, c) {
    switch (arguments.length) {
      case 0:
        return f3;
      case 1:
        return _isPlaceholder_1$2(a) ? f3 : _curry2_1$2(function (_b, _c) {
          return fn(a, _b, _c);
        });
      case 2:
        return _isPlaceholder_1$2(a) && _isPlaceholder_1$2(b) ? f3 : _isPlaceholder_1$2(a) ? _curry2_1$2(function (_a, _c) {
          return fn(_a, b, _c);
        }) : _isPlaceholder_1$2(b) ? _curry2_1$2(function (_b, _c) {
          return fn(a, _b, _c);
        }) : _curry1_1$2(function (_c) {
          return fn(a, b, _c);
        });
      default:
        return _isPlaceholder_1$2(a) && _isPlaceholder_1$2(b) && _isPlaceholder_1$2(c) ? f3 : _isPlaceholder_1$2(a) && _isPlaceholder_1$2(b) ? _curry2_1$2(function (_a, _b) {
          return fn(_a, _b, c);
        }) : _isPlaceholder_1$2(a) && _isPlaceholder_1$2(c) ? _curry2_1$2(function (_a, _c) {
          return fn(_a, b, _c);
        }) : _isPlaceholder_1$2(b) && _isPlaceholder_1$2(c) ? _curry2_1$2(function (_b, _c) {
          return fn(a, _b, _c);
        }) : _isPlaceholder_1$2(a) ? _curry1_1$2(function (_a) {
          return fn(_a, b, c);
        }) : _isPlaceholder_1$2(b) ? _curry1_1$2(function (_b) {
          return fn(a, _b, c);
        }) : _isPlaceholder_1$2(c) ? _curry1_1$2(function (_c) {
          return fn(a, b, _c);
        }) : fn(a, b, c);
    }
  };
}
var _curry3_1$2 = _curry3$2;
function _isObject$2$1(x) {
  return Object.prototype.toString.call(x) === '[object Object]';
}
var _isObject_1$2 = _isObject$2$1;
function _has$4(prop, obj) {
  return Object.prototype.hasOwnProperty.call(obj, prop);
}
var _has_1$2 = _has$4;
var mergeWithKey$2 =              _curry3_1$2(function mergeWithKey(fn, l, r) {
  var result = {};
  var k;
  for (k in l) {
    if (_has_1$2(k, l)) {
      result[k] = _has_1$2(k, r) ? fn(k, l[k], r[k]) : l[k];
    }
  }
  for (k in r) {
    if (_has_1$2(k, r) && !_has_1$2(k, result)) {
      result[k] = r[k];
    }
  }
  return result;
});
var mergeWithKey_1$2 = mergeWithKey$2;
var mergeDeepWithKey$2 =              _curry3_1$2(function mergeDeepWithKey(fn, lObj, rObj) {
  return mergeWithKey_1$2(function (k, lVal, rVal) {
    if (_isObject_1$2(lVal) && _isObject_1$2(rVal)) {
      return mergeDeepWithKey(fn, lVal, rVal);
    } else {
      return fn(k, lVal, rVal);
    }
...
var mergeDeepWithKey_1$2 = mergeDeepWithKey$2;
var mergeDeepRight$1 =              _curry2_1$2(function mergeDeepRight(lObj, rObj) {
  return mergeDeepWithKey_1$2(function (k, lVal, rVal) {
    return rVal;
  }, lObj, rObj);
});
var mergeDeepRight_1$1 = mergeDeepRight$1;
...
var _objectKeysInternal$2 = function (object, names) {
  ...
  var result = [];
  var key;
  for (key in O) if (key != IE_PROTO$1) _has$2$1(O, key) && result.push(key);
  while (names.length > i) if (_has$2$1(O, key = names[i++])) {
...
var _setToStringTag = function (it, tag, stat) {
  if (it && !_has$2$1(it = stat ? it : it.prototype, TAG)) def(it, TAG, { configurable: true, value: tag });
};
'use strict';
var IteratorPrototype = {};
...
var _objectGpo = Object.getPrototypeOf || function (O) {
  O = _toObject$2(O);
  if (_has$2$1(O, IE_PROTO$2)) return O[IE_PROTO$2];
...
var _iterDefine = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      if (!_library && !_has$2$1(IteratorPrototype, ITERATOR)) _hide$2(IteratorPrototype, ITERATOR, returnThis);
    }
  }
...
var pickBy =              _curry2_1$2(function pickBy(test, obj) {
  var result = {};
  for (var prop in obj) {
...
var onFreeze = function (it) {
  if (FREEZE && meta.NEED && isExtensible(it) && !_has$2$1(it, META)) setMeta(it);
  return it;
};
...
var f$7 = _descriptors$2 ? gOPD$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (_has$2$1(O, P)) return _propertyDesc$2(!_objectPie.f.call(O, P), O[P]);
};
var _objectGopd = {
	f: f$7
};
...
var $defineProperty = function defineProperty(it, key, D) {
  ...
  _anObject$2(D);
  if (_has$2$1(AllSymbols, key)) {
    if (!D.enumerable) {
      if (!_has$2$1(it, HIDDEN)) dP$1$1(it, HIDDEN, _propertyDesc$2(1, {}));
      it[HIDDEN][key] = true;
    } else {
      if (_has$2$1(it, HIDDEN) && it[HIDDEN][key]) it[HIDDEN][key] = false;
...
var $propertyIsEnumerable = function propertyIsEnumerable(key) {
  ...
  if (this === ObjectProto$1 && _has$2$1(AllSymbols, key) && !_has$2$1(OPSymbols, key)) return false;
  return E || !_has$2$1(this, key) || !_has$2$1(AllSymbols, key) || _has$2$1(this, HIDDEN) && this[HIDDEN][key] ? E : true;
};
var $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(it, key) {
  it = _toIobject$2(it);
  key = _toPrimitive$2(key, true);
  if (it === ObjectProto$1 && _has$2$1(AllSymbols, key) && !_has$2$1(OPSymbols, key)) return;
  var D = gOPD(it, key);
  if (D && _has$2$1(AllSymbols, key) && !(_has$2$1(it, HIDDEN) && it[HIDDEN][key])) D.enumerable = true;
  return D;
};
var $getOwnPropertyNames = function getOwnPropertyNames(it) {
  ...
  while (names.length > i) {
    if (!_has$2$1(AllSymbols, key = names[i++]) && key != HIDDEN && key != META) result.push(key);
  } return result;
};
var $getOwnPropertySymbols = function getOwnPropertySymbols(it) {
  ...
  var key;
  while (names.length > i) {
    if (_has$2$1(AllSymbols, key = names[i++]) && (IS_OP ? _has$2$1(ObjectProto$1, key) : true)) result.push(AllSymbols[key]);
  } return result;
};
if (!USE_NATIVE$1) {
  $Symbol = function Symbol() {
    ...
    var $set = function (value) {
      ...
      if (_has$2$1(this, HIDDEN) && _has$2$1(this[HIDDEN], tag)) this[HIDDEN][tag] = false;
...
_export$2(_export$2.S + _export$2.F * !USE_NATIVE$1, 'Symbol', {
  'for': function (key) {
    return _has$2$1(SymbolRegistry, key += '')
      ? SymbolRegistry[key]
...
function processHeaders(default_headers, passed_headers) {
  var headers = mergeDeepRight_1$1(default_headers, passed_headers);
  for (var key in headers) {
    if (typeof headers[key] === 'function') {
      headers[key] = headers[key]();
    }
  }
  headers = pickBy_1(isDef$1, headers);
...
var default_options = {
  ...
  var options = mergeDeepRight_1$1(default_options, _options);
  var config = mergeDeepRight_1$1(defaults, _config);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            config = mergeDeepRight_1$1(mergeDeepRight_1$1({ vm: vm }, defaults), _config);
            vm.$request = function () {
